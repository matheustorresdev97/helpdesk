...
export function SidebarMobileLayout() {
    ...
    return (
        <aside className="flex flex-col h-full bg-gray-100 rounded-r-lg">
            <h1 className="text-gray-400 font-bold text-xs font-lato p-5 border-b border-gray-300">
                Menu
            </h1>
            <nav className="flex flex-col mt-2 gap-1 flex-grow">
                {/* TICKETS */}
                <NavLink
                    to="/"
                    className={({ isActive }) =>
