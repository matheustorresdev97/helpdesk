    ...
    <aside className="flex flex-col h-screen bg-white border-r border-gray-200">
      <header>
        <div className="flex gap-3 px-5 py-7 border-b border-gray-200">
          ...
          <div className="mb-6">
            <h1 className="text-gray-600 text-xl font-bold">HelpDesk</h1>
            <p className="text-blue-500 uppercase font-bold text-xs">
      ...
      <nav className="flex flex-col items-center mt-6 gap-1 flex-grow">
        <NavLink
          ...
          className={({ isActive }) =>
            ...
            hover:bg-blue-50 hover:rounded-sm hover:text-gray-600 transition-colors
              ${isActive ? "bg-blue-50 text-gray-600 rounded-sm" : ""}`
          }
        >
          <svg
      ...
      <footer className="relative border-t border-gray-200 mt-auto">
        <div
          className="flex gap-3 p-5 cursor-pointer hover:bg-gray-50 transition-colors"
          ref={profileButtonRef}
          onClick={toggleProfileMenu}
        >
          <div className="bg-blue-100 w-8 h-8 text-gray-600 rounded-full flex items-center justify-center text-sm font-medium">
        ...
        {isProfileMenuOpen && (
          ...
          >
            <ProfileMenu
              ...
              onOpenModal={handleOpenProfileModal}
            />
          </div>
        )}
      </footer>
